...
// 비시즌 던전 보상. 3주 던전이 한 시즌(8주)에 2번 진행됨.
export const NONSEASON_TIERS = [
    {
        max: 9, label: '랭킹 0~9%', rewards: [
            { name: 'JMT 백금 바나나[지급용]', qty: 300 },
            { name: '스페셜 치킨 콤보[지급용]', qty: 150 },
            { name: '슈퍼 경험치 부스터 1000%[지급용]', qty: 30 },
            { name: '디지털 에너지 드링크[지급용]', qty: 9 },
            { name: '레어몬 디지몬 알 [5단][지급용]', qty: 3 },
            { name: '영광의 편린', qty: 90 },
        ]
    },
    {
    ...
    },
    {
        max: 100, label: '랭킹 70~100%', rewards: [
            { name: '백금 바나나[지급용]', qty: 150 },
            { name: '스페셜 치킨 콤보[지급용]', qty: 30 },
            { name: '슈퍼 경험치 부스터 1000%[지급용]', qty: 9 },
        ]
    },
];
